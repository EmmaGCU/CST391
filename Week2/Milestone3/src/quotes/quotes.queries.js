...
exports.quoteQueries = {
    readAllQuotes: 'SELECT quote_id as quoteId, user_id as userId, authors.author_id as authorId, first_name as authorFirst, last_name as authorLast, text, comments, date_added as dateAdded FROM quotes JOIN authors ON quotes.author_id = authors.author_id',
    readQuotesByUser: 'SELECT quote_id as quoteId, user_id as userId, authors.author_id as authorId, first_name as authorFirst, last_name as authorLast, text, comments, date_added as dateAdded FROM quotes JOIN authors ON quotes.author_id = authors.author_id WHERE user_id = ?',
