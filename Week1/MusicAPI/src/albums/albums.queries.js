...
exports.albumQueries = void 0;
exports.albumQueries = {
    ...
    updateAlbum: 'UPDATE music.albums SET title = ?, artist = ?, year = ?, image = ?, description = ? WHERE id = ?',
    deleteAlbum: 'DELETE FROM music.albums WHERE id = ?'
};
//# sourceMappingURL=albums.queries.js.map