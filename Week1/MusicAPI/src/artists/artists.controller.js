...
const ArtistDao = __importStar(require("./artists.dao"));
const readArtists = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const artists = yield ArtistDao.readArtists();
